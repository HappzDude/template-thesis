...
\subsection{Appearance}
Only Chronograf provides a Webinterface for the user. The interface is in  blue withe combination and contains a lot of Black. The Menu is located on an left sidebar. There are only pictures 
