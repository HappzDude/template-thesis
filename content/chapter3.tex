...
The project was originally built at Soundcloud and nowadays it is used by big companies like Jodel (\url{https://jodel.com/de/},05.02.2018), Docker and Core OS (\url{https://prometheus.io/},20.0.1.2018). \\
Prometh2eus also has an alert manager, which is an extra tool to send message including the cluster state via E-Mail, HipChat, PagerDuty, Pushover, Slack, OpsGenie and VictorOps. These alerts have to be set up in an config file. \\
