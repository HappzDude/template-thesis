...
\section{Database}
The Databases for a APM are usual time-series-databases. This special kind of database, saves the data by a time stamp or a timesequence.
...
The over method is that the Database preforms a get operation onto a interface provided by the Collector  
This sorted data can be analyzed to check if there are any anomalies, which were unknown or have changed. This anomalies are often time-dependent. E.g. at 15 pm. are 50 more people online than at 10 am.
